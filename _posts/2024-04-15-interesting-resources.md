...
- [eBPF Library for Go](https://ebpf-go.dev/)
...
- [golang - cmd/trace](https://pkg.go.dev/cmd/trace)
...
- [Linux IP Masquerade HOWTO, David A. Ranch](https://tldp.org/HOWTO/IP-Masquerade-HOWTO/index.html)
